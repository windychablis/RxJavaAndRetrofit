...
/**
 * Created by chablis on 2016/11/15.
 */

public class Project {
    /**
     * summary_id : 9105dcd7247c43479fb3c71e31778415
     * version : 1
     * project_id : 5b09f8dc08644e8b862c8c0f92e93fba
     * deal_main :
     * accept_condition :
     * process : 办证中心窗口受理&amp;rarr;现场勘察&amp;rarr;填写（编制）环保文件&amp;rarr;审批环保文件
     * mater_audit_standard :
     * charge_foundation : 不收费
     * charge_standard :
     * statutory_days : 0
     * statutory_desc : 无
     * promise_days : 0
     * promise_desc : 建设方提供有效材料自受理后1-3天办理完毕
     * license_name :
     * accept_name : 区环保局
     * accept_address : 湾里行政服务中心
     * summary_img :
     * states :
     * remark :
     * special_procedure :
     * special_procedure_day :
     * exam_app_dept :
     * monitor_mode :
     * consulting_mode :
     * cert_name :
     * view_monitor_mode : 无
     * view_consulting_mode : 无
     * apply_material : 1、建设项目审批：立项批文，建设项目选址意见书，建设用地规划许可证，国有土地使用证，使用林地审核同意书（以上为建筑项目）。2、工业企业项目：项目批准文件，原材料、设备、可行性报告或提供产品产量、生产工艺流程、防治污染措施、投资额等资料。
     * foundation : 国务院《建设项目环境保护管理条例》《中华人民共和国水污染防治法实施细则》
     * premit_cond : 无
    ...
    private int statutory_days;
    private String statutory_desc;
    private int promise_days;
    ...
    public int getStatutory_days() {
        return statutory_days;
    }

    public void setStatutory_days(int statutory_days) {
    ...
    public int getPromise_days() {
        return promise_days;
    }

    public void setPromise_days(int promise_days) {
